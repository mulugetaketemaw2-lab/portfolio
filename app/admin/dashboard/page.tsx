        ...
        <nav className="flex-1 px-4 space-y-2 mt-4">
          {[
            ...
            <button
              ...
              className={`w-full text-left px-5 py-4 rounded-2xl font-bold transition-all duration-300 flex items-center space-x-3 group ${activeTab === tab.id
              ...
              <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-xl shadow-navy/5 border border-white/50 group hover:shadow-2xl transition-all duration-500">
                ...
                <form onSubmit={uploadProfilePhoto} className="flex flex-col sm:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    {photoMessage && (
                      <div className={`p-3 rounded-lg text-sm font-medium flex items-center gap-2 ${photoMessage.includes("updated") ? "bg-green-50 text-green-600 border border-green-200" : "bg-red-50 text-red-600 border border-red-200"
                        }`}>
            ...
            <div className="grid lg:grid-cols-12 gap-8 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="lg:col-span-5 bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-xl shadow-navy/5 border border-white/50 h-fit">
                ...
                <form onSubmit={saveProject} className="space-y-4">
                  ...
                  {projectMessage && (
                    <div className={`p-3 rounded-lg text-sm font-medium flex items-center gap-2 ${projectMessage.includes("success") || projectMessage.includes("updated") || projectMessage.includes("deleted")
